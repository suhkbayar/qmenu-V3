...
export const customeModalTheme = {
  root: {
    base: 'fixed top-0 right-0 left-0 z-50 h-full h-screen overflow-y-auto overflow-x-hidden md:inset-0 md:h-full',
    show: {
      on: 'flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80',
      off: 'hidden',
    },
...
export const customLoyaltyModal = {
  root: {
    base: 'fixed top-0 right-0 left-0 z-[100] h-modal h-screen p-3 overflow-y-auto overflow-x-hidden inset-0 h-full',
    show: {
      on: 'flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80',
      off: 'hidden',
    },
