...
const Footer = ({ branch }: Props) => {
  ...
  return (
    <>
      <footer className="relative p-10  bg-white dark:bg-gray-800 pt-10 pb-10 lg:pt-[50px] lg:pb-0">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <p className="text-body-color mb-7 flex text-base">
                  <span className="text-primary  mr-3">
                    <CiLocationOn className="fill-current text-2xl " />
                  </span>
                  <span> {branch ? branch.address : t('mainPage.QmenuAddress')}</span>
                </p>
                ...
                <p className="text-dark flex items-center text-sm font-medium">
                  ...
                  <span>{branch ? branch.phone : '77772040'}</span>
                </p>
              </div>
            </div>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-9 text-lg font-semibold">Холбоосууд</h4>
                <div className="mb-6 flex items-center">
                  ...
                  {branch?.instagram && (
                    <a
                      ...
                      className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                      <svg width="24" height="18" className="fill-current" viewBox="0 0 24 24">
                ...
                <p className="text-body-color text-base">&copy; 2023 QMenu</p>
              </div>
            </div>
          </div>
        </div>
