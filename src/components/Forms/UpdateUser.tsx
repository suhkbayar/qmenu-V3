...
const Index = ({ onSubmit, user, loading }: Props) => {
  ...
  return (
    <div className="md:flex md:justify-center ">
      <form
        className=" w-full md:w-1/3  grid h-[90vh] place-content-between place-items-center  py-5 px-8"
        action=""
      ...
      >
        ...
        <div className="pt-4 pb-2  w-full ">
          <button
            ...
            type="submit"
            className={`  w-full flex items-center  place-content-center rounded-lg px-4 py-2  md: px-5 py-3     ${
